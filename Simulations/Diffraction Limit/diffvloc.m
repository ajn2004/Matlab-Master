...
imy = (sin(2*pi*((X-(i*10+x1)).^2 + (Y-y1).^2).^0.5/(sigs))./(0.00000001+((X-(i*10+x1)).^2 + (Y-y1).^2).^0.5/(sigs))) + (sin(2*pi*((X+(i*10-x2)).^2 + (Y-y2).^2).^0.5/(sigs))./(0.00000001+((X+(i*10-x2)).^2 + (Y-y2).^2).^0.5/(sigs)));
