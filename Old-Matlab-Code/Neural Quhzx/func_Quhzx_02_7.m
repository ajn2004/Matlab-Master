function func_Quhzx_02_7(fpath,fname,an_dir,bkgn,Theta1, Theta2, q,pix2pho,n_start,n_end, wvlngth, NA, finame, amem, sp)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% func_Quhzx v 2.07
%
...
% v 2.07 uses fourier background subtraction
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
sigma2 = sigma2_um/q+1;                       % width in pixels
...
iprod = fourier_gpu_subtract(i1,sp)*20;
disp('Done Subtracting background');

max_neur = 200*200*400*8; %this number is based off simulations
...
save([an_dir,fname(1:end-4),'_frames_',num2str(n_start),'_',num2str(n_end),'_it_',finame(18:end-4),'_t_neuro'],'xf_all','yf_all','N','off_all','sigx_all','sigy_all','sigx_crlb','sigy_crlb', 'xf_crlb','yf_crlb','N_crlb', 'off_crlb', 'sigma2','wvlngth','q','pix2pho','NA','n_start','n_end','Theta1','Theta2','llv','framenum_all','lp2','lp');
end
