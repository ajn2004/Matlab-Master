function func_Quhzx_02_4_with_psf(fpath,fname,an_dir,bkgn,Theta1, Theta2, q,pix2pho,n_start,n_end, wvlngth, NA, n_bkgn)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% func_Quhzx v 2.04
% 
...
%     waitbar(framenum/(n_end-n_start+1),hwait,[num2str(100*framenum/(1+n_end-n_start)),'% complete']);     % pdate waitbar
    ...
    [mol_locs, num_mol] = neural_gpu(a1(:,:,framenum), Theta1.', Theta2.');   % Perform neural net calculation
        ...
        if numel(xpeak)  >0
            for pm = 1:numel(xpeak)
                ...
                if mol_num == 100000
                    ...
                    clear framenum_temp xpeaks ypeaks beta0 
                    if  runs ==1
...
%                         framenum
                        ...
                        y = vertcat(y,framenum_all_temp>0);
%                         framenum
                        disp([num2str(100*framenum/(1+n_end-n_start)),'% complete']);
                        runs = runs+1;
                        i5 = cat(3,i5,i4);
...
save([an_dir,fname(1:end-4),'_frames_',num2str(n_start),'_',num2str(n_end),'_t_neuro_with_psf'],'xf_all','yf_all','N','off_all', 'xf_crlb','yf_crlb','N_crlb', 'off_crlb', 'sigma2','wvlngth','q','pix2pho','NA','n_start','n_end','n_bkgn','bkgn','Theta1','Theta2','llv','framenum_all','lp2','lp','i5','y');
end
