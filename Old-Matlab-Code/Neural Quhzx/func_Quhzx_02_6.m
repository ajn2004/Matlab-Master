function func_Quhzx_02_6(fpath,fname,an_dir,bkgn,Theta1, Theta2, q,pix2pho,n_start,n_end, wvlngth, NA, n_bkgn, finame, amem)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% func_Quhzx v 2.04
%
...
save([an_dir,fname(1:end-4),'_frames_',num2str(n_start),'_',num2str(n_end),'_it_',finame(18:end-4),'_t_neuro'],'xf_all','yf_all','N','off_all','sigx_all','sigy_all','sigx_crlb','sigy_crlb', 'xf_crlb','yf_crlb','N_crlb', 'off_crlb', 'sigma2','wvlngth','q','pix2pho','NA','n_start','n_end','n_bkgn','bkgn','Theta1','Theta2','llv','framenum_all','lp2','lp');
end
