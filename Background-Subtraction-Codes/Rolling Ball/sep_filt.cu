...
void __global__ go_rows( double *d_iall,
	...
	int nrhs, mxArray const *prhs[])
{
	...
	cudaError_t err9 = cudaMemcpyToSymbol("d_iall", &iall, irow*icol*numi*sizeof(double),0, cudaMemcpyHostToDevice);	// copy image data to gpu
	if (err9 != cudaSuccess){
