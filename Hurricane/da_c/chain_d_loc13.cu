...
__global__ void  localize13(double *d_iall,  // pointer to our image variable
	...
	int numi)// pointer for final x-coordinate measurement
{
	...
	__shared__ double xgrid[169];			// allocate xpix and ypix variables to the shared memory of the blocks
	__shared__ double ygrid[169];			// this will reduce calls to global device memory
